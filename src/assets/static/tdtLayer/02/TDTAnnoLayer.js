  ...
  function (declare, TiledMapServiceLayer, Extent, SpatialReference, TileInfo) {
    return declare(esri.layers.TiledMapServiceLayer, {
      constructor: function () {
        ...
        this.initialExtent = (this.fullExtent = new esri.geometry.Extent(-1.9926188851995632E7, -3.0240971958377518E7, 1.9926188851995632E7, 3.0240971958377518E7, this.spatialReference));
        // 图层提供的切片信息
      ...
      getTileUrl: function (level, row, col) {
        return "http://t" + row % 8 + ".tianditu.gov.cn/cva_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=cva&STYLE=default&TILEMATRIXSET=w&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&FORMAT=tiles&tk=5003bc22120f9d66a3276a29bf4be1ed";
      }
    });
  });
